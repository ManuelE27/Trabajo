...
//close(pype[1]); //cierro lado de escritura
 ...
 a=2;
  ...
  while ((ent = readdir (dir)) != NULL ) //b<i/2 or a>i/2 padre leera la primer mitad mientras su contador aumenta +1 por cada iteraciÛn, a leera la segunda mitad mientras su contador baja -1 por cada iteraciÛn
    {
